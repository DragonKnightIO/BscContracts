...
contract DC is DelegateERC20, Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;

    EnumerableSet.AddressSet private _minters;

    constructor(uint256 airdropSupply) ERC20("Dragon Coin", "DC") {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(
            ...
            "Dragon Coin: _addMinter is the zero address"
        );
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(
            ...
            "Dragon Coin: _delMinter is the zero address"
        );
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address) {
        require(
            ...
            "Dragon Coin: index out of bounds"
        );
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "Dragon Coin: caller is not the minter");
        _;
    }
}
